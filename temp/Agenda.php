 ...
 * Version 3.0.3 (doctrine2-annotation) on 2017-07-10 14:25:44.
 ...
 * @ORM\Table(name="agenda", indexes={@ORM\Index(name="fk_agenda_disponibilidad_idx", columns={"disponibilidad_id"}), @ORM\Index(name="fk_agenda_usuario1_idx", columns={"usuario_id"})})
 */
class Agenda
{
    /**
